...
1. ![Lösche Scratchy](loeschen.png){: .right}
Lösche *Scratchy*. Wir brauchen für unser Spiel andere Figuren.

1. ![Zeichne Figur](malen.png){: .right}
...
1. ![Figur laden](hochladen.png){: .right}
...
1. ![Drei Figuren](figuren.png){: .right}
...
1. ![Fehlende Variablen anlegen](labyrinth-daten.png){: .right}
...
![Spielfeld](scratch-spielfeld.png)
...
![Variablen für Spielfeld setzen](code-laby-1.png)
...
![Baue Spielfeld](code-laby-2.png)
...
![Klon positionieren](code-laby-3.png)

1. ![Hauptprogramm für Labyrinth-Element](code-laby-4.png){: .right}
...
1. ![Fehlende Variablen anlegen](code-spieler-1.png){: .right}
...
![Ermittle Spielfeldelement](code-spieler-2.png)
...
![Aktualisiere Spielerposition](code-spieler-3.png)
...
![Bewege Spieler vertikal](code-spieler-3.png)
...
![Bewege Spieler horizontal](code-spieler-4.png)

1. Nachdem du jetzt alle *Hilfsfunktionen* programmiert hast, können wir sie mit der Tastensteuerung verknüpfen.

![Spielstart für den Spieler](code-spieler-5.png)

1. ![Hauptprogramm für Spieler](code-spieler-6.png){: .right}
Jetzt müssen wir nur noch dafür sorgen, dass unsere neuen Blöcke aufgerufen werden, wenn das Programm startet.
...
![Hindernisse zerstören](code-laby-5.png)
...
![Ziel positionieren](code-ziel.png)
