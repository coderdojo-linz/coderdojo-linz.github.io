...
{{< imgblock "img/chess-blocks-en.png" "Stage" >}}
...
{{< imgblock "img/chess-eval-code-en.png" "Board evaluation" 8 >}}
...
{{< imgblock "img/chess-minimax.png" "Move selection" 8 >}}
...
{{< imgblock "img/chess-minimax-code-en.png" "Zugauswahl" 8 >}}
